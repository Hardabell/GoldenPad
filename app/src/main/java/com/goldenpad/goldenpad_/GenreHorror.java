...
public class GenreHorror extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.listViewGenreH);
        getJSON();
    }
    ...
    private void showEmployee() {
        ...
        try {
            ...
            MyCustomListAdapter adapter = new MyCustomListAdapter(GenreHorror.this, list);
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(GenreHorror.this, "Fetching...","Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_EMP_GENRE_HORROR);
                return s;
            }
        }
    ...
    public void back(View view) {
        ...
        Intent i = new Intent(GenreHorror.this , MainActivity.class);
        startActivity(i);
    }
}