...
public class GenreComedy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.listViewGenreC);
        getJSON();
    }
    ...
    private void showEmployee() {
        ...
        try {
            ...
            MyCustomListAdapter adapter = new MyCustomListAdapter(GenreComedy.this, list);
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(GenreComedy.this, "Fetching...","Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_EMP_GENRE_COMEDY);
                return s;
            }
        }
    ...
    public void back(View view) {
        ...
        Intent i = new Intent(GenreComedy.this , MainActivity.class);
        startActivity(i);
    }
}
