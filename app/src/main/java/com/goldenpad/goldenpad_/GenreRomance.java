...
public class GenreRomance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.listViewGenreR);
        getJSON();
    }
    ...
    private void showEmployee() {
        ...
        try {
            ...
            MyCustomListAdapter adapter = new MyCustomListAdapter(GenreRomance.this, list);
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(GenreRomance.this, "Fetching...","Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_EMP_GENRE_ROMANCE);
                return s;
            }
        }
    ...
    public void back(View view) {
        ...
        Intent i = new Intent(GenreRomance.this , MainActivity.class);
        startActivity(i);
    }
}
